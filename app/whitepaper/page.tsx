      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-12 bg-white border border-gray-200 rounded-lg p-8">
          ...
          <div className="space-y-3 text-gray-700 text-sm">
            ...
            <div className="border-l-4 border-blue-600 pl-4">
              <p className="font-bold text-gray-900">Progressive Decentralization</p>
              <p>Launch: Authority-controlled for security & speed. Milestone: Governance transitions to token holders at 10K+ users. Strategy: Earn decentralization through execution.</p>
            </div>
            <div className="border-l-4 border-blue-600 pl-4">
